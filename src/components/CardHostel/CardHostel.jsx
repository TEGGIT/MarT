    ...
    <div className={classes.main__section__content__container}>
      <div className={classes.main__section__content__container__card}>
        ...
        <div className={classes.main__section__content__container__card__info}>
          <div
              className={
                classes.main__section__content__container__card__info__text_top
              }
          >
            <p>{number.category}</p>
          </div>
          {number.info.map((service) => (
              <div
                  className={
                    classes.main__section__content__container__card__info__text
                  }
              >
          ...
          <div
              className={
                classes.main__section__content__container__card__info__status
              }
          >
            ...
            <span
                className={
                  classes.main__section__content__container__card__info__status_color
                }
            >
              СВОБОДНО
            </span>
