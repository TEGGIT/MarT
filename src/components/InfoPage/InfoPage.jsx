    ...
    <>
      ...
      <main className={classes.more}>
        <div className={classes.nav}>
          <p>
            <NavLink to="/numbers-page" className={classes.nav__text}>
              Номера
            </NavLink>{' '}
            {'>'} Подробнее
          </p>
        ...
        <div className={classes.container}>
            ...
            <div className={classes.container__hotelCard_info}>
              ...
              <div className={classes.container__hotelCard__bottomInfo}>
                <div className={classes.container__hotelCard__bottomInfo_info}>
                  <div
                    className={
                      classes.container__hotelCard__bottomInfo_info_price
                    }
                  >
          ...
          <div
            className={classes.container__options}
            style={{ backgroundImage: `url(${BackImgDescription})` }}
          >
            <span className={classes.container__options_title}>
            ...
            <div className={classes.container__options_info}>
              {services.map((service) => (
                <div className={classes.container__options__block}>
                  ...
                  <div onClick={() => replaceServiceState(service)}>
                  ...
                  <span
                    className={
                      servicesState[service.codeName]
                        ...
                        : classes.container__options__block_hidden
                    }
                  >
